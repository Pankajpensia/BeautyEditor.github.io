...
! function(t) {
    ...
    y.cleanData = (o = y.cleanData, function(t) {
        for (var e, i, s = 0; null != (i = t[s]); s++)(e = y._data(i, "events")) && e.remove && y(i).triggerHandler("remove");
        o(t)
    }), y.widget = function(t, i, e) {
        var s, o, n, r = {},
            h = t.split(".")[0],
            a = h + "-" + (t = t.split(".")[1]);
        return e || (e = i, i = y.Widget), Array.isArray(e) && (e = y.extend.apply(null, [{}].concat(e))), y.expr.pseudos[a.toLowerCase()] = function(t) {
            return !!y.data(t, a)
        }, y[h] = y[h] || {}, s = y[h][t], o = y[h][t] = function(t, e) {
            ...
            _proto: y.extend({}, e),
            _childConstructors: []
        }), (n = new i).options = y.widget.extend({}, n.options), y.each(e, function(e, s) {
            function o() {
        ...
        for (var e, i, s = h.call(arguments, 1), o = 0, n = s.length; o < n; o++)
            for (e in s[o]) i = s[o][e], r.call(s[o], e) && void 0 !== i && (y.isPlainObject(i) ? t[e] = y.isPlainObject(t[e]) ? y.widget.extend({}, t[e], i) : y.widget.extend({}, i) : t[e] = i);
        return t
        ...
        y.fn[n] = function(i) {
            ...
            return t ? this.length || "instance" !== i ? this.each(function() {
                ...
                return "instance" === i ? (o = e, !1) : e ? "function" != typeof e[i] || "_" === i.charAt(0) ? y.error("no such method '" + i + "' for " + n + " widget instance") : (t = e[i].apply(e, s)) !== e && void 0 !== t ? (o = t && t.jquery ? o.pushStack(t.get()) : t, !1) : void 0 : y.error("cannot call methods on " + n + " prior to initialization; attempted to call method '" + i + "'")
            }) : o = void 0 : (s.length && (i = y.widget.extend.apply(null, [i].concat(s))), this.each(function() {
                var t = y.data(this, r);
        ...
        _createWidget: function(t, e) {
            e = y(e || this.defaultElement || this)[0], this.element = y(e), this.uuid = i++, this.eventNamespace = "." + this.widgetName + this.uuid, this.bindings = y(), this.hoverable = y(), this.focusable = y(), this.classesElementLookup = {}, e !== this && (y.data(e, this.widgetFullName, this), this._on(!0, this.element, {
                remove: function(t) {
        ...
        _setOptionClasses: function(t) {
            var e, i, s;
            for (e in t) s = this.classesElementLookup[e], t[e] !== this.options.classes[e] && s && s.length && (i = y(s.get()), this._removeClass(s, e), i.addClass(this._classes({
                element: i,
                keys: e,
                classes: t,
                add: !0
        ...
        _classes: function(o) {
            ...
            function t(t, e) {
                for (var i, s = 0; s < t.length; s++) i = r.classesElementLookup[t[s]] || y(), i = o.add ? (function() {
                    var i = [];
                    o.element.each(function(t, e) {
                        y.map(r.classesElementLookup, function(t) {
                            return t
                        }).some(function(t) {
                            return t.is(e)
                        }) || i.push(e)
                ...
                }(), y(y.uniqueSort(i.get().concat(o.element.get())))) : y(i.not(o.element).get()), r.classesElementLookup[t[s]] = i, n.push(t[s]), e && o.classes[t[s]] && n.push(o.classes[t[s]])
            }
            return (o = y.extend({
        ...
        _on: function(o, n, t) {
            var r, h = this;
            "boolean" != typeof o && (t = n, n = o, o = !1), t ? (n = r = y(n), this.bindings = this.bindings.add(n)) : (t = n, n = this.element, r = this.widget()), y.each(t, function(t, e) {
                function i() {
                    if (o || !0 !== h.options.disabled && !y(this).hasClass("ui-state-disabled")) return ("string" == typeof e ? h[e] : e).apply(h, arguments)
                }
        ...
        _trigger: function(t, e, i) {
            ...
            if (i = i || {}, (e = y.Event(e)).type = (t === this.widgetEventPrefix ? t : this.widgetEventPrefix + t).toLowerCase(), e.target = this.element[0], o = e.originalEvent)
        ...
        y.Widget.prototype["_" + n] = function(e, t, i) {
            ...
            "number" == typeof(t = t || {}) ? t = {
                duration: t
            }: !0 === t && (t = {}), s = !y.isEmptyObject(t), t.complete = i, t.delay && e.delay(t.delay), s && y.effects && y.effects.effect[o] ? e[n](t) : o !== n && e[o] ? e[o](t.duration, t.easing, i) : e.queue(function(t) {
                y(this)[n](), i && i.call(e[0]), t()
            })
        }
    });
    var s, C, x, n, a, l, c, p, z;
    y.widget;
    ...
    C = Math.max, x = Math.abs, n = /left|center|right/, a = /top|center|bottom/, l = /[\+\-]\d+(\.[\d]+)?%?/, c = /^\w+/, p = /%$/, z = y.fn.position, y.position = {
        scrollbarWidth: function() {
            if (void 0 !== s) return s;
            var t, e = y("<div style='display:block;position:absolute;width:200px;height:200px;overflow:hidden;'><div style='height:300px;width:auto;'></div></div>"),
                i = e.children()[0];
            return y("body").append(e), t = i.offsetWidth, e.css("overflow", "scroll"), t === (i = i.offsetWidth) && (i = e[0].clientWidth), e.remove(), s = t - i
        },
    ...
    }, y.fn.position = function(p) {
        if (!p || !p.of) return z.apply(this, arguments);
        var f, d, u, g, m, t, _ = "string" == typeof(p = y.extend({}, p)).of ? y(document).find(p.of) : y(p.of),
            v = y.position.getWithinInfo(p.within),
            b = y.position.getScrollInfo(v),
        ...
        return _[0].preventDefault && (p.at = "left top"), d = e.width, u = e.height, m = y.extend({}, g = e.offset), y.each(["my", "at"], function() {
            var t, e, i = (p[this] || "").split(" ");
            (i = 1 === i.length ? n.test(i[0]) ? i.concat(["center"]) : a.test(i[0]) ? ["center"].concat(i) : ["center", "center"] : i)[0] = n.test(i[0]) ? i[0] : "center", i[1] = a.test(i[1]) ? i[1] : "center", t = l.exec(i[0]), e = l.exec(i[1]), P[this] = [t ? t[0] : 0, e ? e[0] : 0], p[this] = [c.exec(i[0])[0], c.exec(i[1])[0]]
        }), 1 === w.length && (w[1] = w[0]), "right" === p.at[0] ? m.left += d : "center" === p.at[0] && (m.left += d / 2), "bottom" === p.at[1] ? m.top += u : "center" === p.at[1] && (m.top += u / 2), f = H(P.at, d, u), m.left += f[0], m.top += f[1], this.each(function() {
            var i, t, r = y(this),
                h = r.outerWidth(),
                a = r.outerHeight(),
                e = I(this, "marginLeft"),
                s = I(this, "marginTop"),
                o = h + e + I(this, "marginRight") + b.width,
                n = a + s + I(this, "marginBottom") + b.height,
                l = y.extend({}, m),
                c = H(P.my, r.outerWidth(), r.outerHeight());
            "right" === p.my[0] ? l.left -= h : "center" === p.my[0] && (l.left -= h / 2), "bottom" === p.my[1] ? l.top -= a : "center" === p.my[1] && (l.top -= a / 2), l.left += c[0], l.top += c[1], i = {
                marginLeft: e,
                marginTop: s
            }, y.each(["left", "top"], function(t, e) {
                y.ui.position[w[t]] && y.ui.position[w[t]][e](l, {
                    targetWidth: d,
                    targetHeight: u,
                    elemWidth: h,
                    elemHeight: a,
                ...
                d < h && x(e + i) < d && (n.horizontal = "center"), u < a && x(s + o) < u && (n.vertical = "middle"), C(x(e), x(i)) > C(x(s), x(o)) ? n.important = "horizontal" : n.important = "vertical", p.using.call(this, t, n)
            }), r.offset(y.extend(l, {
                using: t
            }))
        })
        ...
        fit: {
            left: function(t, e) {
                ...
                e.collisionWidth > o ? 0 < r && h <= 0 ? (i = t.left + r + e.collisionWidth - o - s, t.left += r - i) : t.left = !(0 < h && r <= 0) && h < r ? s + o - e.collisionWidth : s : 0 < r ? t.left += r : 0 < h ? t.left -= h : t.left = C(t.left - n, t.left)
            },
            top: function(t, e) {
                var i = e.within,
                ...
                e.collisionHeight > o ? 0 < r && h <= 0 ? (i = t.top + r + e.collisionHeight - o - s, t.top += r - i) : t.top = !(0 < h && r <= 0) && h < r ? s + o - e.collisionHeight : s : 0 < r ? t.top += r : 0 < h ? t.top -= h : t.top = C(t.top - n, t.top)
            }
        },
        flip: {
            left: function(t, e) {
                var i = e.within,
                    ...
                    r = -2 * e.offset[0];
                h < 0 ? ((s = t.left + l + i + r + e.collisionWidth - o - s) < 0 || s < x(h)) && (t.left += l + i + r) : 0 < a && (0 < (n = t.left - e.collisionPosition.marginLeft + l + i + r - n) || x(n) < a) && (t.left += l + i + r)
            },
            top: function(t, e) {
                var i = e.within,
                    ...
                    r = -2 * e.offset[1];
                h < 0 ? ((s = t.top + l + i + r + e.collisionHeight - o - s) < 0 || s < x(h)) && (t.top += l + i + r) : 0 < a && (0 < (n = t.top - e.collisionPosition.marginTop + l + i + r - n) || x(n) < a) && (t.top += l + i + r)
            }
        },
        flipfit: {
            left: function() {
    ...
    y.ui.focusable = function(t, e) {
        var i, s, o, n, r = t.nodeName.toLowerCase();
        return "area" === r ? (s = (i = t.parentNode).name, !(!t.href || !s || "map" !== i.nodeName.toLowerCase()) && (0 < (s = y("img[usemap='#" + s + "']")).length && s.is(":visible"))) : (/^(input|select|textarea|button|object)$/.test(r) ? (o = !t.disabled) && (n = y(t).closest("fieldset")[0]) && (o = !n.disabled) : o = "a" === r && t.href || e, o && y(t).is(":visible") && function(t) {
    ...
    y.expr.pseudos || (y.expr.pseudos = y.expr[":"]), y.uniqueSort || (y.uniqueSort = y.unique), y.escapeSelector || (e = /([\0-\x1f\x7f]|^-?\d)|^-$|[^\x80-\uFFFF\w-]/g, f = function(t, e) {
    ...
    y.widget("ui.mouse", {
        ...
        _mouseUp: function(t) {
            this.document.off("mousemove." + this.widgetName, this._mouseMoveDelegate).off("mouseup." + this.widgetName, this._mouseUpDelegate), this._mouseStarted && (this._mouseStarted = !1, t.target === this._mouseDownEvent.target && y.data(t.target, this.widgetName + ".preventClickEvent", !0), this._mouseStop(t)), this._mouseDelayTimer && (clearTimeout(this._mouseDelayTimer), delete this._mouseDelayTimer), this.ignoreMissingWhich = !1, u = !1, t.preventDefault()
        },
    ...
    y.widget("ui.draggable", y.ui.mouse, {
        ...
        _mouseDrag: function(t, e) {
            if (this.hasFixedAncestor && (this.offset.parent = this._getParentOffset()), this.position = this._generatePosition(t, !0), this.positionAbs = this._convertPositionTo("absolute"), !e) {
                e = this._uiHash();
                if (!1 === this._trigger("drag", t, e)) return this._mouseUp(new y.Event("mouseup", t)), !1;
        ...
        _createHelper: function(t) {
            var e = this.options,
                ...
                t = i ? y(e.helper.apply(this.element[0], [t])) : "clone" === e.helper ? this.element.clone().removeAttr("id") : this.element;
        ...
        drag: function(i, s, o) {
            y.each(o.sortables, function() {
                var t = !1,
                    e = this;
                e.positionAbs = o.positionAbs, e.helperProportions = o.helperProportions, e.offset.click = o.offset.click, e._intersectsWith(e.containerCache) && (t = !0, y.each(o.sortables, function() {
                    return this.positionAbs = o.positionAbs, this.helperProportions = o.helperProportions, this.offset.click = o.offset.click, t = this !== e && this._intersectsWith(this.containerCache) && y.contains(e.element[0], this.element[0]) ? !1 : t
                    ...
                    return s.helper[0]
                }, i.target = e.currentItem[0], e._mouseCapture(i, !0), e._mouseStart(i, !0, !0), e.offset.click.top = o.offset.click.top, e.offset.click.left = o.offset.click.left, e.offset.parent.left -= o.offset.parent.left - e.offset.parent.left, e.offset.parent.top -= o.offset.parent.top - e.offset.parent.top, o._trigger("toSortable", i), o.dropped = e.element, y.each(o.sortables, function() {
                    this.refreshPositions()
                }), o.currentItem = o.element, e.fromOutside = o), e.currentItem && (e._mouseDrag(i), s.position = e.position)) : e.isOver && (e.isOver = 0, e.cancelHelperRemoval = !0, e.options._revert = e.options.revert, e.options.revert = !1, e._trigger("out", i, e._uiHash(e)), e._mouseStop(i, !0), e.options.revert = e.options._revert, e.options.helper = e.options._helper, e.placeholder && e.placeholder.remove(), s.helper.appendTo(o._parent), o._refreshOffsets(i), s.position = o._generatePosition(i, !0), o._trigger("fromSortable", i), o.dropped = !1, y.each(o.sortables, function() {
                    this.refreshPositions()
                }))
            })
        }
        ...
        start: function(t, e, i) {
            var s = i.options;
            i.snapElements = [], y(s.snap.constructor !== String ? s.snap.items || ":data(ui-draggable)" : s.snap).each(function() {
                var t = y(this),
                    e = t.offset();
        ...
        drag: function(t, e, i) {
            for (var s, o, n, r, h, a, l, c, p, f = i.options, d = f.snapTolerance, u = e.offset.left, g = u + i.helperProportions.width, m = e.offset.top, _ = m + i.helperProportions.height, v = i.snapElements.length - 1; 0 <= v; v--) a = (h = i.snapElements[v].left - i.margins.left) + i.snapElements[v].width, c = (l = i.snapElements[v].top - i.margins.top) + i.snapElements[v].height, g < h - d || a + d < u || _ < l - d || c + d < m || !y.contains(i.snapElements[v].item.ownerDocument, i.snapElements[v].item) ? (i.snapElements[v].snapping && i.options.snap.release && i.options.snap.release.call(i.element, t, y.extend(i._uiHash(), {
                ...
                top: 0,
                left: a
            }).left)), p = s || o || n || r, "outer" !== f.snapMode && (s = Math.abs(l - m) <= d, o = Math.abs(c - _) <= d, n = Math.abs(h - u) <= d, r = Math.abs(a - g) <= d, s && (e.position.top = i._convertPositionTo("relative", {
                top: l,
                left: 0
            }).top), o && (e.position.top = i._convertPositionTo("relative", {
            ...
            }).left)), !i.snapElements[v].snapping && (s || o || n || r || p) && i.options.snap.snap && i.options.snap.snap.call(i.element, t, y.extend(i._uiHash(), {
                snapItem: i.snapElements[v].item
            })), i.snapElements[v].snapping = s || o || n || r || p)
        }
        ...
        start: function(t, e, i) {
            ...
            i.length && (s = parseInt(y(i[0]).css("zIndex"), 10) || 0, y(i).each(function(t) {
    ...
    y.widget("ui.droppable", {
    ...
    }), y.ui.intersect = function(t, e, i, s) {
        if (!e.offset) return !1;
        var o = (t.positionAbs || t.position.absolute).left + t.margins.left,
            n = (t.positionAbs || t.position.absolute).top + t.margins.top,
            r = o + t.helperProportions.width,
            h = n + t.helperProportions.height,
            a = e.offset.left,
            l = e.offset.top,
            c = a + e.proportions().width,
            p = l + e.proportions().height;
        switch (i) {
            case "fit":
                return a <= o && r <= c && l <= n && h <= p;
            case "intersect":
                return a < o + t.helperProportions.width / 2 && r - t.helperProportions.width / 2 < c && l < n + t.helperProportions.height / 2 && h - t.helperProportions.height / 2 < p;
            case "pointer":
                return g(s.pageY, l, e.proportions().height) && g(s.pageX, a, e.proportions().width);
            case "touch":
                return (l <= n && n <= p || l <= h && h <= p || n < l && p < h) && (a <= o && o <= c || a <= r && r <= c || o < a && c < r);
            default:
                return !1
        }
    }, !(y.ui.ddmanager = {
        ...
        prepareOffsets: function(t, e) {
            var i, s, o = y.ui.ddmanager.droppables[t.options.scope] || [],
                n = e ? e.type : null,
        ...
        drag: function(o, n) {
            o.options.refreshPositions && y.ui.ddmanager.prepareOffsets(o, n), y.each(y.ui.ddmanager.droppables[o.options.scope] || [], function() {
                var t, e, i, s;
                this.options.disabled || this.greedyChild || !this.visible || (s = !(i = y.ui.intersect(o, this, this.options.tolerance, n)) && this.isover ? "isout" : i && !this.isover ? "isover" : null) && (this.options.greedy && (e = this.options.scope, (i = this.element.parents(":data(ui-droppable)").filter(function() {
                    return y(this).droppable("instance").options.scope === e
                })).length && ((t = y(i[0]).droppable("instance")).greedyChild = "isover" === s)), t && "isover" === s && (t.isover = !1, t.isout = !0, t._out.call(t, n)), this[s] = !0, this["isout" === s ? "isover" : "isout"] = !1, this["isover" === s ? "_over" : "_out"].call(this, n), t && "isout" === s && (t.isout = !1, t.isover = !0, t._over.call(t, n)))
            })
        },
    ...
    y.widget("ui.resizable", y.ui.mouse, {
        ...
        _setupHandles: function() {
            var t, e, i, s, o, n = this.options,
                r = this;
            if (this.handles = n.handles || (y(".ui-resizable-handle", this.element).length ? {
                    n: ".ui-resizable-n",
                    e: ".ui-resizable-e",
                    s: ".ui-resizable-s",
                    w: ".ui-resizable-w",
                ...
                for ("all" === this.handles && (this.handles = "n,e,s,w,se,sw,ne,nw"), i = this.handles.split(","), this.handles = {}, e = 0; e < i.length; e++) s = "ui-resizable-" + (t = String.prototype.trim.call(i[e])), o = y("<div>"), this._addClass(o, "ui-resizable-handle " + s), o.css({
                    zIndex: n.zIndex
        ...
        _mouseStart: function(t) {
            var e, i, s = this.options,
                o = this.element;
            return this.resizing = !0, this._renderProxy(), e = this._num(this.helper.css("left")), i = this._num(this.helper.css("top")), s.containment && (e += y(s.containment).scrollLeft() || 0, i += y(s.containment).scrollTop() || 0), this.offset = this.helper.offset(), this.position = {
                left: e,
                top: i
                ...
                left: t.pageX,
                top: t.pageY
            }, this.aspectRatio = "number" == typeof s.aspectRatio ? s.aspectRatio : this.originalSize.width / this.originalSize.height || 1, s = y(".ui-resizable-" + this.axis).css("cursor"), y("body").css("cursor", "auto" === s ? this.axis + "-resize" : s), this._addClass("ui-resizable-resizing"), this._propagate("start", t), !0
        },
        ...
        _mouseStop: function(t) {
            ...
            }, i = parseFloat(n.element.css("left")) + (n.position.left - n.originalPosition.left) || null, s = parseFloat(n.element.css("top")) + (n.position.top - n.originalPosition.top) || null, o.animate || this.element.css(y.extend(e, {
                top: s,
                left: i
            })), n.helper.height(n.size.height), n.helper.width(n.size.width), this._helper && !o.animate && this._proportionallyResize()), y("body").css("cursor", "auto"), this._removeClass("ui-resizable-resizing"), this._propagate("stop", t), this._helper && this.helper.remove(), !1
        },
        ...
        _respectSize: function(t) {
            var e = this._vBoundaries,
                ...
                l = /sw|nw|w/.test(i),
                i = /nw|ne|n/.test(i);
            return n && (t.width = e.minWidth), r && (t.height = e.minHeight), s && (t.width = e.maxWidth), o && (t.height = e.maxHeight), n && l && (t.left = h - e.minWidth), s && l && (t.left = h - e.maxWidth), r && i && (t.top = a - e.minHeight), o && i && (t.top = a - e.maxHeight), t.width || t.height || t.left || !t.top ? t.width || t.height || t.top || !t.left || (t.left = null) : t.top = null, t
        },
        ...
        stop: function(e) {
            ...
            i.element.animate(y.extend(o, n && r ? {
                top: n,
                left: r
            } : {}), {
        ...
        start: function() {
            var i, s, o = y(this).resizable("instance"),
                t = o.options,
                e = o.element,
                n = t.containment,
                r = n instanceof y ? n.get(0) : /parent/.test(n) ? e.parent().get(0) : n;
            r && (o.containerElement = y(r), /document/.test(n) || n === document ? (o.containerOffset = {
                left: 0,
                top: 0
            }, o.containerPosition = {
                left: 0,
            ...
            }) : (i = y(r), s = [], y(["Top", "Right", "Left", "Bottom"]).each(function(t, e) {
        ...
        stop: function() {
            ...
            t._helper && !e.animate && /relative/.test(o.css("position")) && y(this).css({
                left: r.left - s.left - i.left,
                width: h,
                height: n
            }), t._helper && !e.animate && /static/.test(o.css("position")) && y(this).css({
                left: r.left - s.left - i.left,
                width: h,
                height: n
            })
    ...
    y.ui.resizable, y.widget("ui.selectable", y.ui.mouse, {
        ...
        _mouseCapture: function(t, e) {
            ...
            return !this.reverting && (!this.options.disabled && "static" !== this.options.type && (this._refreshItems(t), y(t.target).parents().each(function() {
                if (y.data(this, o.widgetName + "-item") === o) return i = y(this), !1
            }), !!(i = y.data(t.target, o.widgetName + "-item") === o ? y(t.target) : i) && (!(this.options.handle && !e && (y(this.options.handle, i).find("*").addBack().each(function() {
                this === t.target && (s = !0)
            }), !s)) && (this.currentItem = i, this._removeCurrentsFromItems(), !0))))
        },
        _mouseStart: function(t, e, i) {
            var s, o, n = this.options;
            if ((this.currentContainer = this).refreshPositions(), this.appendTo = y("parent" !== n.appendTo ? n.appendTo : this.currentItem.parent()), this.helper = this._createHelper(t), this._cacheHelperProportions(), this._cacheMargins(), this.offset = this.currentItem.offset(), this.offset = {
        ...
        _mouseDrag: function(t) {
            ...
            for (this.position = this._generatePosition(t), this.positionAbs = this._convertPositionTo("absolute"), this.options.axis && "y" === this.options.axis || (this.helper[0].style.left = this.position.left + "px"), this.options.axis && "x" === this.options.axis || (this.helper[0].style.top = this.position.top + "px"), n.scroll && !1 !== this._scroll(t) && (this._refreshItemPositions(!0), y.ui.ddmanager && !n.dropBehaviour && y.ui.ddmanager.prepareOffsets(this, t)), this.dragDirection = {
                    vertical: this._getDragVerticalDirection(),
                    horizontal: this._getDragHorizontalDirection()
                }, e = this.items.length - 1; 0 <= e; e--)
                if (s = (i = this.items[e]).item[0], (o = this._intersectsWithPointer(i)) && i.instance === this.currentContainer && !(s === this.currentItem[0] || this.placeholder[1 === o ? "next" : "prev"]()[0] === s || y.contains(this.placeholder[0], s) || "semi-dynamic" === this.options.type && y.contains(this.element[0], s))) {
        ...
        _mouseStop: function(t, e) {
            var i, s, o, n;
            if (t) return y.ui.ddmanager && !this.options.dropBehaviour && y.ui.ddmanager.drop(this, t), this.options.revert ? (s = (i = this).placeholder.offset(), n = {}, (o = this.options.axis) && "x" !== o || (n.left = s.left - this.offset.parent.left - this.margins.left + (this.offsetParent[0] === this.document[0].body ? 0 : this.offsetParent[0].scrollLeft)), o && "y" !== o || (n.top = s.top - this.offset.parent.top - this.margins.top + (this.offsetParent[0] === this.document[0].body ? 0 : this.offsetParent[0].scrollTop)), this.reverting = !0, y(this.helper).animate(n, parseInt(this.options.revert, 10) || 500, function() {
                i._clear(t)
            })) : this._clear(t, e), !1
        },
        cancel: function() {
        ...
        _getItemsAsjQuery: function(t) {
            ...
            if (h && t)
                for (e = h.length - 1; 0 <= e; e--)
                    for (i = (s = y(h[e], this.document[0])).length - 1; 0 <= i; i--)(o = y.data(s[i], this.widgetFullName)) && o !== this && !o.options.disabled && r.push(["function" == typeof o.options.items ? o.options.items.call(o.element) : y(o.options.items, o.element).not(".ui-sortable-helper").not(".ui-sortable-placeholder"), o]);
            ...
            for (r.push(["function" == typeof this.options.items ? this.options.items.call(this.element, null, {
                ...
                }) : y(this.options.items, this.element).not(".ui-sortable-helper").not(".ui-sortable-placeholder"), this]), e = r.length - 1; 0 <= e; e--) r[e][0].each(a);
            return y(n)
        },
        ...
        _refreshItems: function(t) {
            ...
            var e, i, s, o, n, r, h, a, l = this.items,
                c = [
            ...
            if (p && this.ready)
                for (e = p.length - 1; 0 <= e; e--)
                    for (i = (s = y(p[e], this.document[0])).length - 1; 0 <= i; i--)(o = y.data(s[i], this.widgetFullName)) && o !== this && !o.options.disabled && (c.push(["function" == typeof o.options.items ? o.options.items.call(o.element[0], t, {
                        item: this.currentItem
                    }) : y(o.options.items, o.element), o]), this.containers.push(o));
            for (e = c.length - 1; 0 <= e; e--)
                for (n = c[e][1], a = (r = c[e][i = 0]).length; i < a; i++)(h = y(r[i])).data(this.widgetName + "-item", n), l.push({
                    item: h,
                    instance: n,
                    width: 0,
                    height: 0,
        ...
        _refreshItemPositions: function(t) {
            for (var e, i, s = this.items.length - 1; 0 <= s; s--) e = this.items[s], this.currentContainer && e.instance !== this.currentContainer && e.item[0] !== this.currentItem[0] || (i = this.options.toleranceElement ? y(this.options.toleranceElement, e.item) : e.item, t || (e.width = i.outerWidth(), e.height = i.outerHeight()), i = i.offset(), e.left = i.left, e.top = i.top)
        },
        ...
        _createPlaceholder: function(i) {
            ...
            }), i.placeholder = y(n.placeholder.element.call(i.element, i.currentItem)), i.currentItem.after(i.placeholder), n.placeholder.update(i, i.placeholder)
        },
        ...
        _contactContainers: function(t) {
            for (var e, i, s, o, n, r, h, a, l, c = null, p = null, f = this.containers.length - 1; 0 <= f; f--) y.contains(this.currentItem[0], this.containers[f].element[0]) || (this._intersectsWith(this.containers[f].containerCache) ? c && y.contains(this.containers[f].element[0], c.element[0]) || (c = this.containers[f], p = f) : this.containers[f].containerCache.over && (this.containers[f]._trigger("out", t, this._uiHash(this)), this.containers[f].containerCache.over = 0));
            if (c)
                if (1 === this.containers.length) this.containers[p].containerCache.over || (this.containers[p]._trigger("over", t, this._uiHash(this)), this.containers[p].containerCache.over = 1);
                else {
                    for (i = 1e4, s = null, o = (a = c.floating || this._isFloating(this.currentItem)) ? "left" : "top", n = a ? "width" : "height", l = a ? "pageX" : "pageY", e = this.items.length - 1; 0 <= e; e--) y.contains(this.containers[p].element[0], this.items[e].item[0]) && this.items[e].item[0] !== this.currentItem[0] && (r = this.items[e].item.offset()[o], h = !1, t[l] - r > this.items[e][n] / 2 && (h = !0), Math.abs(t[l] - r) < i && (i = Math.abs(t[l] - r), s = this.items[e], this.direction = h ? "up" : "down"));
        ...
        _createHelper: function(t) {
            var e = this.options,
                t = "function" == typeof e.helper ? y(e.helper.apply(this.element[0], [t, this.currentItem])) : "clone" === e.helper ? this.currentItem.clone() : this.currentItem;
        ...
        _generatePosition: function(t) {
            var e = this.options,
                i = t.pageX,
                s = t.pageY,
                o = "absolute" !== this.cssPosition || this.scrollParent[0] !== this.document[0] && y.contains(this.scrollParent[0], this.offsetParent[0]) ? this.scrollParent : this.offsetParent,
